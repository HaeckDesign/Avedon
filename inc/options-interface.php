...
function avedontheme_fields() {
	...
	foreach ( $options as $value ) {
		...
		// Uploader
		case "upload":
			$output .= avedontheme_uploader( $value['id'], $val, null );
		...
		case 'background':
			...
			$output .= avedontheme_uploader( $value['id'], $background['image'], null, esc_attr( $option_name . '[' . $value['id'] . '][image]' ) );
