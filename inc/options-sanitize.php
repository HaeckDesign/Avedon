...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'avedon_theme_options' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'avedon_theme_options' ),
		'repeat-y'  => __( 'Repeat Vertically', 'avedon_theme_options' ),
		'repeat'    => __( 'Repeat All', 'avedon_theme_options' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'avedon_theme_options' ),
		'top center'    => __( 'Top Center', 'avedon_theme_options' ),
		'top right'     => __( 'Top Right', 'avedon_theme_options' ),
		'center left'   => __( 'Middle Left', 'avedon_theme_options' ),
		'center center' => __( 'Middle Center', 'avedon_theme_options' ),
		'center right'  => __( 'Middle Right', 'avedon_theme_options' ),
		'bottom left'   => __( 'Bottom Left', 'avedon_theme_options' ),
		'bottom center' => __( 'Bottom Center', 'avedon_theme_options' ),
		'bottom right'  => __( 'Bottom Right', 'avedon_theme_options')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'avedon_theme_options' ),
		'fixed'  => __( 'Fixed in Place', 'avedon_theme_options')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'avedon_theme_options' ),
		'italic'      => __( 'Italic', 'avedon_theme_options' ),
		'bold'        => __( 'Bold', 'avedon_theme_options' ),
		'bold italic' => __( 'Bold Italic', 'avedon_theme_options' )
	);
