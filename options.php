...
function avedontheme_options() {
	...
	$options[] = array(
		...
		'desc' => __('<p>Avedon is a Wordpress Theme designed to utilize a lot of technologies that much brighter folks have built (see below). Any and all respect should be given to them. Haeck Design is always available for projects, but since it is a theme - support cant be guaranteed. That said, we will always do our best to respond to functional issues in a timely manner.<hr /><h4>Demo</h4><p>http://demo.haeckdesign.com/avedon/</p><hr /><h4>Support</h4><p>https://github.com/HaeckDesign/Avedon/issues</p><hr /><h4>Purchase Advanced Version</h4><p>Buy an advanced version of the Avedon theme by visiting our demo page and clicking the "buy" button.</p><hr /><h4>Credits</h4><ul class="line"><li>For more information regarding Bootstrap, please refer to http://getbootstrap.com</li><li>For more information regarding Supersize, please refer to BuildInternet.com</li><li>For more information regarding Wordpress, please refer to the Wordpress Codex</li></ul>', 'avedon_theme_options'),
		'type' => 'info');
