...
function avedontheme_options() {
	...
	$options[] = array(
		...
		'desc' => __('<p>Avedon is a Wordpress Theme designed to utilize a lot of technologies that much brighter folks have built (see below). Any and all respect should be given to them. Haeck Design is always available for projects, but since it is a theme - support cant be guaranteed. That said, we will always do our best to respond to functional issues in a timely manner.<hr /><p><i class="icon16 icon-links alignright"></i><b>Demo</b>:&nbsp;&nbsp;<a href="http://demo.haeckdesign.com/avedon/" title="Avedon WordPress Theme Demo" target="_blank">http://demo.haeckdesign.com/avedon/</a></p><hr /><p><i class="icon16 icon-links alignright"></i><b>Support</b>:&nbsp;&nbsp;<a href="https://github.com/HaeckDesign/Avedon/issues" title="Avedon Support" target="_blank">https://github.com/HaeckDesign/Avedon/issues</a></p><hr /><p><i class="icon16 icon-links alignright"></i><b>Purchase Advanced Version</b>:&nbsp;&nbsp;<a href="http://demo.haeckdesign.com/avedon/checkout/" title="Purchase Avedon Advanced" target="_blank">http://demo.haeckdesign.com/avedon/checkout/</a></p><hr /><h4>Credits</h4><ul class="line"><li>For more information regarding Bootstrap, please refer to <a href="http://getbootstrap.com/" title="Twitter Bootstrap">GetBootstrap.com</a></li><li>For more information regarding Supersize, please refer to <a href="http://buildinternet.com/project/supersized/" title="Supersized JS">BuildInternet.com</a></li><li>For more information regarding Wordpress, please refer to the <a href="http://codex.wordpress.org/">Wordpress Codex</a></li></ul>', 'avedon_theme_options'),
		'type' => 'info');
