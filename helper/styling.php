...
echo '#main-menu .dropdown-toggle, #main-menu > .menu-item, #main-menu .dropdown-toggle a, .navbar-brand, .navbar-nav > li > a { font-family: ' . $typography['face']. '; font-size:'.$typography['size'] . '; line-height: '.$typography['size'] . '; font-style: ' . $typography['style'] . '; color:'.$typography['color'].'; } #controls-wrapper, .navbar-inverse .navbar-brand, .navbar-inverse .nav > li > a, .socialbox a:hover, .dropdown-menu > li > a:hover, #main-menu > .menu-item a:hover, #wrap .navbar-brand, .navbar .navbar-header .glyphicon {color:'. $typography['color'].'; } .navbar .navbar-header .navbar-toggle .icon-bar {background-color:'. $typography['color'].'; }  '; } ?>
...
if ($color) { echo '.middle, .middle a { color: ' . of_get_option('middle_text_color') . ' ;}' ; } ?>
...
if ($color) { echo '#footer .foot, #footer .foot a, #footer .foot ul li a { color: ' . of_get_option('footer_text_color') . ' ;}' ; } ?>
