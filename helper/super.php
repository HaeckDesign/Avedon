...
if (!empty($multicheck['scrollarrows'])) { echo '<a id="prevslide" class="circled glyphicon glyphicon-chevron-left"></a><a id="nextslide" class="circled glyphicon glyphicon-chevron-right"></a>'; } else {};
if (!empty($multicheck['progbar'])) { echo '<div id="progress-back" class="load-item"><div id="progress-bar"></div></div>'; } else {};
echo '<div id="controls-wrapper" class="load-item navbar navbar-inverse navbar-fixed-bottom"><div id="controls" class="container">';
